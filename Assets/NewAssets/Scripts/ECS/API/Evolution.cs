...
namespace mycoolfin.TheSimsulator.UnityIntegration.ECS.API
{
    ...
    public static class Evolution
    {
        ...
        public static IEnumerator AssessPhenotypes(World world, TrialType trialType, float assessmentSeconds, Func<SimulationRateMode> GetSimulationRateModeCallback)
        {
            EntityManager entityManager = world.EntityManager;
