...
namespace mycoolfin.TheSimsulator.UnityIntegration.Sims.UI.TwoD
{
    ...
    public class ZooModeMenu : MonoBehaviour
    {
        ...
        public SelectedCreatureMenu selectedCreatureMenu;
        ...
        private void InitialiseSelectedPhenotypeMenu()
        {
            ...
            selectedCreatureMenu.EnableBreedButton(() =>
            {
                ...
                else if (selectedCreatureMenu.SelectedCreature != null)
                    ToggleBreeding(true);
            });
            ...
            // {
            //     selectedCreatureMenu.SetTarget(selected.Count > 0 ? selected[0].gameObject.GetComponent<Phenotype>() : null);
            // };
        ...
        private void ToggleBreeding(bool breeding)
        {
            ...
            {
                TogglePlacing(false);
                readyParent = selectedCreatureMenu.SelectedCreature;
            }
            else
                readyParent = null;
        }
