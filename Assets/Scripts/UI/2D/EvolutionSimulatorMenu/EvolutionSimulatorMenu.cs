    ...
    public class EvolutionSimulatorMenu : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            simulator.OnEcsWorldCreated += (ecsWorld) =>
            {
                ...
                ECS.API.PresentationSettings.SetColorByFitness(ecsWorld, false);
                ECS.API.PresentationSettings.SetFilterBySurvivors(ecsWorld, false, simulator.MaxSurvivors);
            };
        }
        ...
        private void Update()
        {
            ...
            {
                var simulationRateInfo = ECS.API.SimulationSettings.GetSimulationRateInfo(ecsWorld);
        ...
        {
            ECS.API.PresentationSettings.SetColorByFitness(ecsWorld, enabled);
        }

        private void SetFilterBySurvivors(bool enabled)
        {
            ECS.API.PresentationSettings.SetFilterBySurvivors(ecsWorld, enabled, simulator.MaxSurvivors);
        }
    }
}
